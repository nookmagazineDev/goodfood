          ...
          meta: {
            ...
            hint: hasDirectDb()
              ? 'ต่อตรงไม่ติดและ host API ก็ไม่ตอบ — ที่เครื่องออฟฟิศลองเปิด http://localhost:14365/aoringo/ping ' +
                'ถ้าได้แปลว่า tunnel หลุด ถ้าไม่ได้แปลว่า host-server ยังไม่ได้รันโค้ดใหม่ (รีสตาร์ท node server.js)'
              : 'ยังไม่ได้ตั้ง AORINGO_DB_USER/PASSWORD (หรือ QCRD_DB_* / ZK_DB_* / HR_DB_*) ที่ฝั่งเว็บ ' +
