...
//
// ที่ร้าน SQL Server ไม่ได้เปิดพอร์ตออกเน็ตตลอดเวลา (ดู docs/franchise-aoringo.md) แต่ฝั่งเว็บ
...
//
// ทางที่มีทางถอยจึงใช้กติกาชุดนี้:
...
export function explainHostError(err, { base, timeoutMs } = {}) {
  ...
  const officeHint =
    ...
    '(ที่เครื่องนั้นลองเปิด http://localhost:14365/aoringo/ping ดูก่อน ถ้าได้แปลว่า tunnel เป็นตัวที่หลุด)';
