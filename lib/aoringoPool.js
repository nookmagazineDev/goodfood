// ต่อ SQL Server ของร้านเฟรนไชส์ตรงจากฝั่งเว็บ — ฐาน Aoringo
//
// เครื่องเริ่มต้นคือ 203.154.185.48 (ชื่อโดเมนเดิมคือ inventory.dyndns.tv) ตัวเดียวกับที่ระบบอื่น
// ของร้านใช้อยู่ ต่างกันแค่ "ฐานข้อมูล" เท่านั้น
//
...
//
// ⚠️ login ที่ใช้ต้องได้สิทธิ์ในฐาน Aoringo ด้วย
