...
| `0002-daily-voucher-discount-column.patch` | เพิ่มคอลัมน์ **Voucher (ส่วนลด)** ต่อจากช่อง "ส่วนลด" ในหน้า "ยอดขายรายวัน" — รวมส่วนลดเฉพาะบิลที่มีคำว่า voucher/คูปอง กดตัวเลขดูบิลเบื้องหลังได้ |
