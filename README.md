...
| `0002-voucher-as-payment-channel.patch` | นับ **voucher เป็นวิธีจ่าย ไม่ใช่ส่วนลด** — ช่อง Voucher ไปอยู่ในกลุ่มช่องทางจ่าย (เงินสด/บัตร/QR/**Voucher**) · ยอดขายของบิลที่ใช้ voucher เป็น "ยอดจริงก่อนใช้ voucher" · ช่อง "ส่วนลด" ไม่มี voucher ปน · การ์ดกับกราฟบนแดชบอร์ดใช้กติกาเดียวกัน |
